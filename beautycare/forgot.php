...
?>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 offset-md-3 mb-40">
            <h4 class="text-gray mt-0 pt-10"> Forgot Password</h4>
            <hr>
           
            <form method="POST" class="forgot_password">
            <div>
              <label>Email:</label>
              <input type="text"  class="form-control" name="email_id" onchange='validEmail(this.event);' placeholder="Enter Email Id" required /><br>
              
            </div>
            <div class="bottom">
              <input type="submit" class="btn btn-dark" value="Send reminder" name="submit"></input><br><br>
              <a href="index.php" rel="login" class="linkform">Suddenly remebered? Log in here</a><br>
  ...
  $sql = "select * from customer where email_id = '$email_id' and status = 0";
        ...
        while($row = mysqli_fetch_array($result))
            ...
            $pass= $row['password'];
                  ...
                  if($pass)
                        {
                          echo "<script language='javascript'>window.location.href='resetpassword.php?email_id=".$email_id."';</script>";
                        }
                        
                      }
                      else
                      {
                        echo "<script language='javascript'>alert('Email id is wrong');</script>";
                      }
                    }
                  ?>  
