...
<h2 class="title" style="margin-bottom: -100px;">Our Product</h2>
    ...
    $sql = "select * from beauty_product where status=0 and category_id='".$_REQUEST['category_id']."'";
                      ...
                      <div class="product">
                        <div class="product-header">
                          ...
                          <div class="product-button-holder">
                            <ul class="shop-icons">
                              <li class="item"><a href="single.php?product_id=<?php echo $row['product_id'];  ?>" class="button btn-quickview" title="Product quick view"></a></li>
