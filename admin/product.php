...
<!----------end forign key---->
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="product_name" class="form-control" placeholder="Enter product name" style="width:500px; 
                            float:left; margin-left: -17px;" required>
                        </div>
                    </div>
...
<input type="file" class="form-control" name="image1" placeholder="Image1" style="height: 70px;  padding-top:5px;" required>
</div>
<div class="form-group" >
<input type="file" class="form-control" name="image2" placeholder="Image2" style="height: 70px;  padding-top:5px;" required>
</div>
<div class="form-group">
<input type="text" class="form-control" name="price" id="price" placeholder="Price" onblur="sum()" required>
</div>
<div class="form-group">
<input type="text" class="form-control" name="discount" id="discount" placeholder="Discount" onblur="sum()" required>
</div>
<div class="form-group">
...
<div class="form-group">
<textarea class="form-control" name="ingredients" placeholder="Ingredients" required></textarea>
</div>
...
<select name="category_id"  class="form-control" style="height:50px;" >
            ...
            if(isset($_SERVER['PHP_SELF']))
            {
                ...
                while($row = mysqli_fetch_array($result))
                { ?>
                    <option value = '<?=$row[0]?>' <?php if($category_id==$row[0]){ echo "selected='selected'"; } ?> ><?=$row[1];?></option>
                <?php }
            }
            ?>
</select>
        ...
        <div class="jumbotron" style="width:1250px; float: right;  margin-right: -120px;background-color: cadetblue;">
            ...
            <div class="card">
                <div class="card-body" style="overflow: scroll;background-color: lightgrey;">
                 ...
                 $query="select pl.category_name,lgn.* from beauty_product lgn INNER JOIN
...
<td rowspan="2" >
                                    <button type="button" class="btn btn-success editbtn"> EDIT </button><br><br>
