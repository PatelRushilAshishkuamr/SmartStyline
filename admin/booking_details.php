...
<p><a href="index.php">Dashboard</a> <i class="fas fa-caret-right"></i>Booking Detalis</p>
</div>
</div>
</div>
</div>
...
<tbody>
    ...
    $sql = "select pl.product_name,lgn.* from order_detail lgn INNER JOIN
        beauty_product pl ON pl.product_id=lgn.product_id where lgn.status=0";
...
{
  $id=$_GET['id'];
$sql1 = "UPDATE order_detail set status='approve' where id='$id'";
